...
$photo_file = basename($student_details['photo']);
$photo_path = "../admin/uploads/students/" . $photo_file;
?>
...
<?php if (file_exists(__DIR__ . '/../admin/uploads/students/' . $photo_file)): ?>
    <img src="<?php echo $photo_path; ?>" 
         alt="Profile Photo"
         class="rounded-circle mb-3"
         style="width:150px;height:150px;object-fit:cover;border:5px solid var(--primary-color);">
<?php else: ?>
                <div class="bg-purple text-dark rounded-circle d-inline-flex align-items-center justify-content-center mb-3" 
            ...
            <form method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" name="email" value="<?php echo htmlspecialchars($student_details['email']); ?>" disabled>
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Phone Number *</label>
                        <input type="tel" class="form-control" name="phone" value="<?php echo htmlspecialchars($student_details['phone']); ?>" required disabled>
                    </div>
                </div>
